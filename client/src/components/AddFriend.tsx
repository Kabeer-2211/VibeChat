...
const AddFriend = ({ imageUrl, imageFallback = 'U', username, email, isAdded = false }: { imageUrl: string, imageFallback: string, username: string, email: string, isAdded?: boolean }) => {
    return (
